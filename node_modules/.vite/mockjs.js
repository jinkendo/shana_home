      ...
      return function(modules) {
            ...
            array: function(options) {
              ...
              if (!options.rule.parameters) {
                ...
                if (options.rule.min === 1 && options.rule.max === void 0) {
                  ...
                  result = Random.pick(Handler.gen(options.template, void 0, {
                    path: options.context.path,
                    templatePath: options.context.templatePath,
                    currentContext: result,
                    templateCurrentContext: options.template,
                  ...
                  if (options.rule.parameters[2]) {
                    ...
                    options.context.path.push(options.name);
                    options.context.templatePath.push(options.name);
                    result = Handler.gen(options.template, void 0, {
                      path: options.context.path,
                      templatePath: options.context.templatePath,
                      currentContext: result,
                      templateCurrentContext: options.template,
        ...
        function(module2, exports2) {
          ...
          Util.type = function type(obj) {
            return obj === null || obj === void 0 ? String(obj) : Object.prototype.toString.call(obj).match(/\[object (\w+)\]/)[1].toLowerCase();
          };
        ...
        function(module2, exports2, __webpack_require__) {
          ...
          module2.exports = {
            parse: function(name) {
              ...
              var count = range ? !range[2] ? parseInt(range[1], 10) : Random.integer(min, max) : void 0;
              var decimal = parameters && parameters[4] && parameters[4].match(Constant.RE_RANGE);
              var dmin = decimal && decimal[1] && parseInt(decimal[1], 10);
              var dmax = decimal && decimal[2] && parseInt(decimal[2], 10);
              var dcount = decimal ? !decimal[2] && parseInt(decimal[1], 10) || Random.integer(dmin, dmax) : void 0;
              var result = {
                parameters,
                range,
                min,
        ...
        function(module2, exports2, __webpack_require__) {
          ...
          }).call(exports2, __webpack_require__(9)(module2));
        },
        function(module2, exports2) {
        ...
        function(module2, exports2) {
          ...
          var parser = function() {
            ...
            function u(n2) {
              ...
              function c() {
                var l2, u3, t2, r2, o2;
                return l2 = qt, u3 = i(), u3 !== null ? (t2 = qt, n2.charCodeAt(qt) === 124 ? (r2 = fl, qt++) : (r2 = null, Wt === 0 && e(sl)), r2 !== null ? (o2 = c(), o2 !== null ? (r2 = [r2, o2], t2 = r2) : (qt = t2, t2 = il)) : (qt = t2, t2 = il), t2 === null && (t2 = al), t2 !== null ? (Lt = l2, u3 = hl(u3, t2), u3 === null ? (qt = l2, l2 = u3) : l2 = u3) : (qt = l2, l2 = il)) : (qt = l2, l2 = il), l2;
              }
              function i() {
                var n3, l2, u3, t2, r2;
        ...
        function(module2, exports2, __webpack_require__) {
          ...
          function toJSONSchema(template, name, path) {
            ...
            switch (result.type) {
              ...
              case "object":
                result.properties = [];
                Util.each(template, function(value, name2) {
        ...
        function(module2, exports2, __webpack_require__) {
          module2.exports = __webpack_require__(28);
        },
        function(module2, exports2, __webpack_require__) {
          var Util = __webpack_require__(3);
          ...
          Util.extend(MockXMLHttpRequest.prototype, {
            open: function(method, url, async, username, password) {
              ...
              function handle(event) {
                for (var i2 = 0; i2 < XHR_RESPONSE_PROPERTIES.length; i2++) {
                  try {
                    that[XHR_RESPONSE_PROPERTIES[i2]] = xhr[XHR_RESPONSE_PROPERTIES[i2]];
                  } catch (e) {
                  }
                }
